<section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="menu-sidebar"><a href="{{ url('/mahasiswa') }}"><span class="fa fa-calendar-minus-o"></span> Manage Mahasiswa</span></a></li>

        <li class="menu-sidebar"><a href="{{ url('/kandidat') }}"><span class="fa fa-calendar-minus-o"></span> Manage Kandidat</span></a></li>
